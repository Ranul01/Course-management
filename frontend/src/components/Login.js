...
export default function Login() {
    ...
    async function submit(e){
        ...
        try{
            await axios.post("http://localhost:8000/customer-server/customer/login",{
                username,password
            })
            .then(res=>{
                if(res.data=="exist"){
        ...
        <div className="Login " >
            ...
            <div class="card text-center" style={{width: '37%'}}>
                ...
                <img src="img7.png" style={{maxHeight:'150px',width: '30%'}} alt="..."/>
                    <h1 class="card-title"  style={{color: '#EAB333'}}><b>Login</b></h1>
                    <br></br>
                    <br></br>
                    ...
                    <form action="POST">
                        ...
                        <button type="submit" class="btn"  style={{ marginRight: '50px', backgroundColor: '#EAB333', borderColor:'#EAB333'}} onClick={submit}>LOGIN</button>
                        <br></br>
                        <br></br>
