    ...
    <div >
      <div class="card bg-dark text-white"  >
        ...
        <div class="card-img-overlay">
          <br></br>
          <br></br>
          <h1 class="card-title" style={{ fontSize: '90px' }}><b>ADMIN</b> <b style={{ color: '#EAB333' }}>DASHBOARD</b></h1>
          <br></br>
          <br></br>
          <br></br>
      ...
      <div >
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4" style={{ marginLeft: '550px', alignSelf: 'center' }}>


          {/*<div class="col" style={{ maxWidth: '300px', marginLeft: '40px' }}>
            <div class="card text-white" style={{ height: '300px', filter: 'brightness(80%)', backgroundColor: '#EAB333' }}>
              <br></br>
              <br></br>
              <center>
          ...
          <div class="col" style={{ maxWidth: '300px', marginLeft: '40px' }}>
            <div class="card text-white" style={{ height: '300px', filter: 'brightness(80%)', backgroundColor: '#EAB333' }}>
              ...
              <center>
                ...
                <br></br>
                <br></br>
                <h2 class="card-title"><b class="text-white">PAYMENTS</b></h2>
              </center>
              <br></br>
              <div class="card-body">
                <Link to='/paymentdash'>
          ...
          <div class="col" style={{ maxWidth: '300px', marginLeft: '40px' }}>
            <div class="card text-white" style={{ height: '300px', filter: 'brightness(80%)', backgroundColor: '#EAB333' }}>
              ...
              <center>
                ...
                <br></br>
                <br></br>
                <h2 class="card-title"><b class="text-white">COURSES</b></h2>
              </center>
              <br></br>
              <div class="card-body">
                <Link to='/coursedash'>
