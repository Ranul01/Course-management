    ...
    return (
        ...
        <div >
            <div class="card bg-dark text-white" >
                <img src="HeaderImg.jpeg" class="card-img" alt="..." style={{ height: '375px', filter: 'brightness(40%)' }} />
                <div class="card-img-overlay">
                    <br></br>
                    <br></br>
                    <h1 class="card-title" style={{ fontSize: '70px', textAlign: 'left', float: 'left', maxWidth: '700px' }}><b>LEARNING NEVER EXHAUSTS THE</b><b style={{ color: '#EAB333'}} > MIND</b></h1>
                ...
                <div class="carousel-inner">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <br></br>
                                        <button type="button" class="btn2  btn-lg " style={{ marginRight: '50px',  backgroundColor: '#EAB333'}} >LEARN MORE</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="card mb-3" style={{ width: '1300px' }}>
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="img2.jpeg" class="img-fluid rounded-start" alt="..." />
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                ...
                <div class="row g-0">
                    <div class="col-md-4">
                        <div class="card-body">
                            ...
                            <button type="button" class="btn2 btn-lg" style={{ marginLeft: '240px',  backgroundColor: '#EAB333' }}>LEARN MORE</button>
                        </div>
                    </div>
                    <div class="col-md-8" >
            ...
            <div class="card mb-3" style={{ width: '1300px' }}>
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="img3.jpeg" class="img-fluid rounded-start" alt="..." />
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <p class="card-text" style={{ width: '700px' }}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages.</p>
