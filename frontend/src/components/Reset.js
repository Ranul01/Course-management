...
export default function Reset() {
    ...
    async function submit(e){
        ...
        try{
            await axios.post("http://localhost:8000/customer-server/customer/resetpw",{
                password,repassword
            })
            .then(res=>{
                if(res.data=="pass"){
        ...
        <div className="Login " >
            ...
            <div class="card text-center" style={{width: '37%'}}>
                ...
                <img src="img7.png" style={{maxHeight:'150px',width: '30%'}} alt="..."/>
                    <h1 class="card-title" style={{color: "#EAB333"}}><b>Reset Password</b></h1>
                    ...
                    <form action="POST">
                        ...
                        <button type="submit" class="btn" onClick={submit} style={{ marginRight: '50px', backgroundColor: '#EAB333', borderColor:'#EAB333'}}>Reset</button>
                        <br></br>
                        <br></br>
